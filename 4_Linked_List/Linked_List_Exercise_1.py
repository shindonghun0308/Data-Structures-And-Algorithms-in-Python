...
######################################### Ex 1 Answer ###############################
    ...
    def insert_after_value(self, data_after, data_to_insert): #add a value to where the data_after is found
...
if __name__ == '__main__':
    ll = LinkedList()
    ll.insert_values([1,2,3,5,4,5,6,7])
    ll.print()
    ll.insert_after_value(5,"Shin")
    ll.print()
    pass
